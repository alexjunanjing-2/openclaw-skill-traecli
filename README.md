# TRAE CLI Skill for OpenClaw

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)
[![OpenClaw Skill](https://img.shields.io/badge/OpenClaw-Skill-blue.svg)](https://clawhub.com)

> 🤖 TRAE CLI installation, configuration and usage guide for OpenClaw

## Overview

This skill provides comprehensive documentation and guidance for using **TRAE CLI** - an AI-powered CLI programming assistant that supports natural language driven development.
...
TRAE CLI provides a series of special syntaxes for dynamically referencing parameters, setting default values, and inserting system command execution results in command definitions.
...
`${N:-DefaultValue}` is used to provide default values for variables. If variable N is not defined or is empty, use DefaultValue as a substitute.
...
5. **Monitor Usage**: Keep track tab of your usage consumption, especially when using Max mode
...
This skill is provided as part of OpenClaw. Please refer to the OpenClaw license for usage terms.

## Contributing

To contribute improvements to this skill, please submit issues or pull requests to the [GitHub repository](https://github.com/alexjunanjing-2/openclaw-skill-traecli).
